        ...
        <div className="main">
            <body>
                ...
                /*<div className='intro-container'>
                    ...
                    <div className="info"><div className="invite">ENGAGEMENT</div><br></br>Celebrate With us<br></br>4 pm 11.02.2024<br></br>Cocktail Attire<br></br>Parking in Retail Garage (in front of starbucks)<br></br>Small bites and libations served<br></br>
